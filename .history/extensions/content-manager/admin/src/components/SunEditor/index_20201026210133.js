...
//                 this.closeLoading();
//                 const err = 'Таны оруулсан зураг ' + (limitSize/1000) + 'KB-с хэтэрсэн байна. Та зүүн цэсэнд байрлах "Media Library" зориулалтын файлын санд зургаа оруулсныхаа дараа линкийг нь хуулж аваад энэхүү "Editor"-ийн Image цэсний "Image URL" талбарт буулгана уу!';
...
//         try {
//             console.log('onRender_imgUrl', 'try')
//             if(!contextImage._v_src._linkValue.includes('http')){
//                 let tmp = contextImage._v_src._linkValue.indexOf('//')
//                 let url = contextImage._v_src._linkValue.slice(tmp+2,contextImage._v_src._linkValue.length)
//                 contextImage._v_src._linkValue = window.location.origin + '/' + url
//             }
